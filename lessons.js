...
const QUEST_LESSONS = [
  ...
  },
  {
    ...
    missions: [
      { phase: "Lesson", title: "Ring-finger drops", practice: "x , x ,", note: "Drop from S to X and from L to comma.", learning: { heading: "Reach with your ring fingers", copy: "X belongs to the left ring finger; comma belongs to the right ring finger.", steps: ["Start on S and L.", "Drop the ring finger without shifting your hand.", "Return to home after each press."], goal: "Goal: make a small, relaxed ring-finger reach." } },
